---
title: 'New publication: <em>An approach to artificial concept learning based on human
  concept learning by using artificial neural networks</em>'
...
The work <u>An approach to artificial concept learning based on human concept learning by using artificial neural networks</u> has been published in <em>Advancing Artificial Intelligence Through Biological Process Applications, <em>pp. 130-145</em></em>.
...
For more details on this work, visit <a href='/publications/books/2008-advancingai'>its own page</a>.
