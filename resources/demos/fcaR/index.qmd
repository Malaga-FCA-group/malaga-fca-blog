...
1. Install R for your operating system: [CRAN](https://cran.r-project.org/) and (optional, but recommended) install RStudio, an IDE for R: [RStudio Desktop](https://posit.co/download/rstudio-desktop/).

2. (Within R console) Install one dependency to plot lattices: 
...
[`fcaR` repository](https://malaga-fca-group.github.io/fcaR/).

![](figs/pkgdown.png)

<!-- # The most important thing to remember from this presentation

![](figs/fcaR-leviosa.jpg) -->
